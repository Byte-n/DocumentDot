...
//
// const worker = new Worker('res/DotWorker.js');
...
//         this.k = Math.random().toString()
//         worker.postMessage({
//             t: 'setData',
//             k: this.k,
//             data: {canvas: this.offscreen, ctxMode: this.ctxMode, radius: this.radius,color:{fill:this.color.fill(this),stroke:this.color.stroke(this)}}
//         }, [this.offscreen]);
//         this.refreshCache();
//     }
//
...
//                 t: 'setData',
//                 k: this.k,
//                 data: {color:{fill:this.color.fill(this),stroke:this.color.stroke(this)}}
//             });
//             this._refreshCache = true;
//         }
